      ...
      touchMove(e){
        ...
        if(this.moveX < this.startX) {// 左滑
           ...
           if(this.diffX > 40) {
             ...
             translateX = this.diffX === 0 ? 0 : '-'+ this.diffX +'px'
           }
          parentElement.style.transform ='translate3d('+ translateX +',0,0)'
        } else {
			      	this.endX = e.changedTouches[0].clientX
              this.diffX = this.endX - this.startX
              translateX = this.diffX > 40 ? 0 : this.diffX +'px'
              parentElement.style.transform ='translate3d('+ translateX +',0,0)'
        }
      },
			//滑动结束
			touchEnd(e){
				...
				this.endX = e.changedTouches[0].clientX
        if(this.diffX < 40) {
          parentElement.style.transform ='translate3d(0,0,0)'
